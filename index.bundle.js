...
/* harmony import */ var _genearators_password__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./genearators/password */ "./src/scripts/genearators/password/index.js");
/* harmony import */ var _genearators_passphrase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./genearators/passphrase */ "./src/scripts/genearators/passphrase/index.js");
// load styles
...
function updateAvailableChars() {
  ...
  if (settingsAllowNumbersEl.checked) availableChars = new Set([...availableChars, ..._genearators_password__WEBPACK_IMPORTED_MODULE_1__.NUMBERS]);
  if (settingsAllowUppercaseEl.checked) availableChars = new Set([...availableChars, ..._genearators_password__WEBPACK_IMPORTED_MODULE_1__.UPPERCASE]);
  if (settingsAllowLowercaseEl.checked) availableChars = new Set([...availableChars, ..._genearators_password__WEBPACK_IMPORTED_MODULE_1__.LOWERCASE]);
  if (settingsAllowSymbolsEl.checked) availableChars = new Set([...availableChars, ..._genearators_password__WEBPACK_IMPORTED_MODULE_1__.SPECIAL_CHARACTERS]);
...
function createPassword() {
  ...
  const generator = new _genearators_password__WEBPACK_IMPORTED_MODULE_1__["default"](availableChars, passwordLength);
...
function createPassphrase() {
  ...
  const generator = new _genearators_passphrase__WEBPACK_IMPORTED_MODULE_2__["default"](_genearators_passphrase__WEBPACK_IMPORTED_MODULE_2__.PASSPHRASE_WORDLIST, passphraseLength, separator, includeNumbers, capitalize);
  return generator.generate()
}
...
function initalizePageElements() {
  document.getElementById('settings-allow-symbols-list').innerHTML = Array.from(_genearators_password__WEBPACK_IMPORTED_MODULE_1__.SPECIAL_CHARACTERS).map((el) =>
